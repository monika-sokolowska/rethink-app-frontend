...
@Entity
@Table(name = "compensated_footprint")
public class CompensatedFootprint {

    @Id
    @GeneratedValue(strategy= GenerationType.AUTO)
    @Column(name = "id_compensated_footprint", columnDefinition = "INT")
    private Integer id;
    ...
    @JoinColumn(name = "id_daily_footprint", referencedColumnName = "id_daily_footprint",
            foreignKey = @ForeignKey(name = "fk_compensated_daily_footprint"))
